...
public class MallsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setNavigationItemSelectedListener(
                new NavigationView.OnNavigationItemSelectedListener() {
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        ...
                        if (id == R.id.nav_home) {
                            Intent navHome = new Intent(MallsActivity.this, MainActivity.class);
                            startActivity(navHome);

                        } else if (id == R.id.nav_hotels) {
                            Intent navHotel = new Intent(MallsActivity.this, HotelsActivity.class);
                            startActivity(navHotel);

                        } else if (id == R.id.nav_cinema) {
                            Intent navCinema = new Intent(MallsActivity.this, CinemaActivity.class);
                            startActivity(navCinema);


                        } else if (id == R.id.nav_recreation) {
                            Intent navRecreation = new Intent(MallsActivity.this, RecreationActivity.class);
                            startActivity(navRecreation);

                        } else if (id == R.id.nav_restaurants) {
                            Intent navRestaurants = new Intent(MallsActivity.this, RestaurantsActivity.class);
                            startActivity(navRestaurants);

                        } else if (id == R.id.nav_stadiums) {
                            Intent navStadium = new Intent(MallsActivity.this, StadiumActivity.class);
        ...
        ArrayList<locations> Malls = new ArrayList<locations>();
        Malls.add(new locations(getString(R.string.mall1), getString(R.string.mall_address1), R.drawable.shoprite_mall));
        Malls.add(new locations(getString(R.string.mall2), getString(R.string.mall_address2), R.drawable.aladinma_mall));
        Malls.add(new locations(getString(R.string.mall3), getString(R.string.mall_address3), R.drawable.house_of_freeda));
        Malls.add(new locations(getString(R.string.mall4), getString(R.string.mall_address4), R.drawable.yudala_mall));

        // Create an {@link AndroidFlavorAdapter}, whose data source is a list of
        // {@link AndroidFlavor}s. The adapter knows how to create list item views for each item
        // in the list.
        LocationAdapter places = new LocationAdapter(this, Malls);

        // Get a reference to the ListView, and attach the adapter to the listView.
        ListView listView = (ListView) findViewById(R.id.malls_list);
